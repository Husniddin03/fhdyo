            ...
            <div class="mb-6">
                ...
                <div id="questionsContainer" class="space-y-3">
                    ...
                    <div class="question-item flex items-center gap-3 p-3 bg-gray-50 rounded-md">
                        <span class="question-number text-sm font-medium text-gray-600 min-w-[30px]">1.</span>
                        ...
                        <button type="button" onclick="removeQuestion(this)"
                            class="remove-btn hidden text-red-600 hover:text-red-800 p-2 rounded-md hover:bg-red-50 transition">
                ...
                <p class="mt-2 text-sm text-gray-500">
                    Add questions for this category (optional). You can also add questions later.
                </p>
            </div>
