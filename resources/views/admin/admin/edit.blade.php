<x-admin.main page='admin.admin.update' title="Admin malumotlarini yangilash">
            ...
            <div class="card mb-6">
                <div class="card-body gap-6">
                    <div class="border-base-content/20 flex items-end gap-6 border-b pb-4">
                        <h2 class="text-3xl">Admin malumotlari</h2>
                    </div>
                    <form class="space-y-6" method="POST" action="{{ route('admin.admin.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input value="{{ $user->password ?? '' }}" type="text" id="pasport_id" name="password"
                                    class="input" placeholder="AD0123456" />
                                <p class="text-error">
                                    @error('password')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="w-full">Qo'shimcha malumotlar</div>
                            <div></div>
                            {{-- jins --}}
                            <div>
                            ...
                            <div>
                                ...
                                <input value="{{ $user->data->jshshir ?? '' }}" type="jshshir" id="jshshir"
                                    name="jshshir" class="input" placeholder="12345678901234" />
                                <p class="text-error">
                                    @error('jshshir')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div>
                                ...
                                <input value="{{ $user->data->phone ?? '' }}" type="text" id="number"
                                    name="phone" class="input" placeholder="+(998) 99 999 99 99" />
                                <p class="text-error">
                                    @error('phone')
                                        {{ $message }}
                                    @enderror
