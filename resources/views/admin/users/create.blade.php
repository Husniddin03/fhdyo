<x-admin.main page='admin.users.create' title="Yangi foydalanuvchi yaratish">
                    ...
                    <form class="space-y-6" method="POST" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input value="{{ old('jshshir') }}" type="jshshir" id="jshshir" name="jshshir"
                            ...
                            <div>
                                ...
                                <input value="{{ old('passport_id') }}" type="text" id="pasport_id"
                            ...
                            <div>
                                ...
                                <input value="{{ old('phone') }}" type="text" id="number" name="phone"
